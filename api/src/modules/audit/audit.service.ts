...
export class AuditService {
  ...
  async log(
    ...
    if (context) {
      ...
      createAuditLogDto.userAgent =
        createAuditLogDto.userAgent || context.userAgent;
      ...
      if (!createAuditLogDto.actorId && context.user) {
        ...
        createAuditLogDto.actorType = context.user.organizationId
          ? 'STAFF'
          : 'USER';
        createAuditLogDto.actorName =
          context.user.username || context.user.fullName || context.user.name;
      }
    }
